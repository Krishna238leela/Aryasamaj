											...
											<div class="blog__tags">
                                                <div class="blog__tags-left">
                                                    ...
                                                    <div class="blog__tags-details">
                                                        <ul>
                                                            <li><a href="dayanand-fullview.php">AryaSamaj</a></li>
                                                            <li><a href="dayanand-fullview.php">Wedding Rituals</a></li>
                                                            <li><a href="dayanand-fullview.php">vedic Education</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="sidebar">
                            ...
                            <div class="sidebar__catagory">
                                ...
                                <div class="section__wrapper">
                                    <ul>
                                        <li><a href="dayanand-fullview.php"><i class="fas fa-chevron-right"></i>Vedic Education</a></li>
                                        <li><a href="dayanand-fullview.php"><i class="fas fa-chevron-right"></i>Wedding</a></li>
                                        <li><a href="dayanand-fullview.php"><i class="fas fa-chevron-right"></i>Yoga Classes</a></li>
                                        <li><a href="dayanand-fullview.php"><i class="fas fa-chevron-right"></i>Library</a></li>
                                        <li><a href="dayanand-fullview.php"><i class="fas fa-chevron-right"></i>Sunday Satsang</a></li>
                                        <li><a href="dayanand-fullview.php"><i class="fas fa-chevron-right"></i>Youth Empowerment</a></li>
