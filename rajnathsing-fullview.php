                                ...
                                <div class="blog__item">
                                    <div class="blog__inner">
                                        <div class="blog__thumb">
                                            <img src="/images/kk.jpg" alt="blog thumb">
                                        </div>
                                        <div class="blog__content">
                                           <h4>Rajnath Singh lauds Arya Samaj for promoting girls' education, clean environment.</h4>
                                            <ul class="blog__content-metapost">
                                                <li><i class="far fa-calendar"></i>12 Jul, 2018</li>
                                                
                                            </ul>
                                            <p>Home Minister Rajnath Singh Sunday praised the contributions of social reformer Swami Dayananda Saraswati to the society, saying his foundation Arya Samaj has been working tirelessly to promote girls' education and clean environment.</p>
                                           <p>Singh made the remarks at the concluding event of a four-day global convention of the Arya Samaj where he was the chief guest.

India's strength is in Indianness, it is in cultural unity. As strong the unity is as powerful India will be, he said.</p>
											...
											<div class="blog__tags">
                                                <div class="blog__tags-left">
                                                    ...
                                                    <div class="blog__tags-details">
                                                        <ul>
                                                            <li><a href="rajnathsing-fullview.php">AryaSamaj</a></li>
                                                            <li><a href="rajnathsing-fullview.php">Wedding Rituals</a></li>
                                                            <li><a href="rajnathsing-fullview.php">vedic Education</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="sidebar">
                            ...
                            <div class="sidebar__catagory">
                                ...
                                <div class="section__wrapper">
                                    <ul>
                                        <li><a href="rajnathsing-fullview.php"><i class="fas fa-chevron-right"></i>Vedic Education</a></li>
                                        <li><a href="rajnathsing-fullview.php"><i class="fas fa-chevron-right"></i>Wedding</a></li>
                                        <li><a href="rajnathsing-fullview.php"><i class="fas fa-chevron-right"></i>Yoga Classes</a></li>
                                        <li><a href="rajnathsing-fullview.php"><i class="fas fa-chevron-right"></i>Library</a></li>
                                        <li><a href="rajnathsing-fullview.php"><i class="fas fa-chevron-right"></i>Sunday Satsang</a></li>
                                        <li><a href="rajnathsing-fullview.php"><i class="fas fa-chevron-right"></i>Youth Empowerment</a></li>
