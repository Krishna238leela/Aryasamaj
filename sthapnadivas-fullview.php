...
<body>
    ...
    <!-- ================> PageHeader section start here <================== -->
     <div class="pageheadersize" style="background-image: url(images/events-banner.jpg);">
        <div class="container">
                        ...
                        <div class="event__item">
                            <div class="event__inner">
                                <div class="event__content pt-0">
                                    <h3>Arya Samaj Celebrates 28th Sthapna Divas</h3>
                                    <div class="event__metapost">
                                        <ul class="event__metapost-info">
                                            <li><i class="far fa-clock"></i>10:40</li>
                                            <li><i class="fas fa-map-marker-alt"></i>Hyderabad</li>
                                    ...
                                    <div class="event__thumb mb-3">
                                        <img src="/images/pooja-full.jpg" alt="event thumb">
									...
									<p><b>Info:</b></p>
									<p>Arya Samaj Greater Houston celebrated its 28th Sthapna Divas (Foundation Day) on April 6th and 7th with a health fair and a cultural program. The celebrations started with a walk for peace and a health fair on the morning of Saturday, April 6th. The fair included check ups and talks on medical issues common to our community.</p>
									<p><b>Contact:</b> +91-8309801619</p>
								</div>
                            </div>
                        </div>
                    </div>
