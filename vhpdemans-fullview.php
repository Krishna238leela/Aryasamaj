                                ...
                                <div class="blog__item">
                                    <div class="blog__inner">
                                        <div class="blog__thumb">
                                            <img src="/images/ag.jpg" alt="blog thumb">
                                        </div>
                                        <div class="blog__content">
                                           <h4>VHP demands probe into activities of social activist Swami Agnivesh</h4>
                                            <ul class="blog__content-metapost">
                                                <li><i class="far fa-calendar"></i>12 Jul, 2018</li>
                                                
                                            </ul>
                                            <p>Claiming that social activist Swami Agnivesh's antecedents were doubtful, VHP today demanded a probe into his activities and asked Arya Samaj to clarify whether he is its leader or not.</p>
                                           <p>We demand a probe by the government into the circumstances in which Agnivesh landed in Kashmir and took part in protests. VHP state patron Rama Kant Dubey told reporters here today. Agnivesh were today detained, along with JKLF chairman Yaseen Malik, when they tried to lead a march toward.</p>
											...
											<div class="blog__tags">
                                                <div class="blog__tags-left">
                                                    ...
                                                    <div class="blog__tags-details">
                                                        <ul>
                                                            <li><a href="vhpdemans-fullview.php">AryaSamaj</a></li>
                                                            <li><a href="vhpdemans-fullview.php">Wedding Rituals</a></li>
                                                            <li><a href="vhpdemans-fullview.php">vedic Education</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
...
?>
  ...
  <?php } else{?>
                                        <form action="" method="post">
                                            ...
                                            <input name="phone" id="phone" type="text" value="" placeholder="Contact Number" class="w-100">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="sidebar">
                                                    ...
                                                    <div class="footer__post-item">
                                                        <div class="footer__post-inner">
                                                            <div class="footer__post-thumb">
                                                                <a href="pmnarendramodi-fullview.php"><img src="/images/nm.jpg" alt="footer post"></a>
                                                            </div>
                                                            <div class="footer__post-content">
                                                                <a href="pmnarendramodi-fullview.php"><h6>PM Narendra Modi pays tribute to Dayananda Saraswathi on his birth aniversary</h6></a>
                                                                <p><i class="far fa-calendar-alt"></i>10 Dec, 2018</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="footer__post-item">
                            ...
                            <div class="sidebar__catagory">
                                ...
                                <div class="section__wrapper">
                                    <ul>
                                        <li><a href="vhpdemans-fullview.php"><i class="fas fa-chevron-right"></i>Vedic Education</a></li>
                                        <li><a href="vhpdemans-fullview.php"><i class="fas fa-chevron-right"></i>Wedding</a></li>
                                        <li><a href="vhpdemans-fullview.php"><i class="fas fa-chevron-right"></i>Yoga Classes</a></li>
                                        <li><a href="vhpdemans-fullview.php"><i class="fas fa-chevron-right"></i>Library</a></li>
                                        <li><a href="vhpdemans-fullview.php"><i class="fas fa-chevron-right"></i>Sunday Satsang</a></li>
                                        <li><a href="vhpdemans-fullview.php"><i class="fas fa-chevron-right"></i>Youth Empowerment</a></li>
